...
public class AuthorizationHandler : IAuthorizationFilter
{
    ...
    private static string _enviromentVariable = Environment.GetEnvironmentVariable("ConsigneeService");
    private static long _serviceId = string.IsNullOrEmpty(_enviromentVariable) ? 5 : Convert.ToInt64(_enviromentVariable);
